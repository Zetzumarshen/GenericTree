...
class GenericTreeTest extends \PHPUnit_Framework_TestCase {
	...
	public function test_insert() {
		...
		$this->assertEquals(4, $tr->root->getChild(3)->value);
		$this->assertEquals("3,1", $tr->root->getChild(2)->getChild(0)->value);
		$this->assertEquals("3,1,1", $tr->root->getChild(2)->getChild(0)->getChild(0)->value);
	}
	...
	public function test_getChild() {
		...
		$this->assertNotEmpty($n->root->getChild(2)->getChild(0));
		$this->assertEquals($n->root->getChild(2)->getChild(0)->value,"3,1");
		$this->assertNotEquals($n->root->getChild(2)->getChild(0)->value,3.1);
	}
